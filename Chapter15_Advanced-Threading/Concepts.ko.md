...
> **선수 지식**: [프로그래밍언어] Java (제1-14장). [운영체제] 스레드 동기화 (제13장).
>
> **학습 목표**:
> 1. java.util.concurrent 유틸리티(ExecutorService, Future)를 적용할 수 있다
> 2. 스레드 안전 자료구조를 위해 동시 컬렉션을 사용할 수 있다
> 3. BlockingQueue로 생산자-소비자 패턴을 구현할 수 있다
